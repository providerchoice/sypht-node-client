 ...
 */
     ...
     * @param {String} workflowId e.g. 'validate'
     * @param {Object} workflowOptions.
     */
    async fileUpload(fieldSets, filePath, workflowId, workflowOptions ){
        try{
            ...
            workflowId != undefined && formData.append('workflowId', JSON.stringify(workflowId));
            workflowOptions != undefined && formData.append('workflowOptions', JSON.stringify(workflowOptions));
